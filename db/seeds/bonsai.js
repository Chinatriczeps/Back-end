...
exports.seed = function(knex, Promise) {
  ...
  const createList = createNewUsers.then(() => {
    return knex('action').returning('*').insert([
        {id: 1, name: '2 hour workout', description: 'Have spent 2 hours in a gym', date: new Date(2018, 10, 1), redFlag: false, user_id: 1},
        {id: 2, name: 'Ate a burger', description: 'Had a burger', date: new Date(2018, 10, 2), redFlag: true, user_id: 1},
        {id: 3, name: 'Went to BP', description: 'Had 3 slices of pizza', date: new Date(2018, 10, 2), redFlag: true, user_id: 2},
        {id: 4, name: 'Went to LHL loundge', description: 'Played a piano', date: new Date(2018, 10, 4), redFlag: false, user_id: 2}
      ])
  })
  return createList;
